...
import 'package:flutter_wisata_app/core/extensions/string_ext.dart';
...
class _UpdateTicketDialogState extends State<UpdateTicketDialog> {
  ...
  void initState() {
    ...
    priceController = TextEditingController(
      text: (widget.item.price ?? 0).currencyFormatRp,
    );
    categoryNotifier = ValueNotifier<Category?>(widget.item.category);
    criteriaNotifier = ValueNotifier<String>(
      widget.item.criteria?.toLowerCase() == 'perorangan' 
        ? 'Perorangan' 
        : 'Rombongan',
    );
                          ...
                          return Button.filled(
                            onPressed: () {
                              ...
                              context.read<ProductBloc>().add(
                                    ProductEvent.updateTicket(updatedProduct),
                                  );
                            },
                            label: 'Update',
                            borderRadius: 8.0,
