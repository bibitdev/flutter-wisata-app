...
import 'package:flutter_wisata_app/presentation/home/dialogs/delete_ticket_dialog.dart';
import 'package:flutter_wisata_app/presentation/home/dialogs/edit_ticket_dialog.dart';
            ...
            children: [
              ...
              IconButton(
                onPressed: () {
                  showDialog(
                    context: context,
                    builder: (context) => DeleteTicketDialog(id: item.id!),
                  );
                },
